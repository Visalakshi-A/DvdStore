        ...
        <c:if test = "${null == status}">
            ...
            <div style = "float: right; margin-right: 100px;"><form method = "get">
                ...
                <button formaction = "display-dvds-by-name">
                    <img src="<c:url value = '/resource/img/search.png'/>" height="15" width="15"/></button>
            </form></div>
                    ...
                    <form method = "post">
                        ...
                        <c:if test = "${null == status}">
                            <td><button formaction = "update-form" 
                                ...
                                <img src="<c:url value = '/resource/img/edit.png' />" height="15" width="15"/></button></td>
                            <td><button formaction = "delete"
                                onclick = "return confirm('Do you want to Delete ${dvd.name}?')">
                                <img src="<c:url value = '/resource/img/delete.png'/>" height="15" width="15"/></button></td>
                        </c:if>
                        <c:if test = "${null != status}">
