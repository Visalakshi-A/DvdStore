...
<html>
    ...
    <body>
        ...
        <form:form method = "post" autocomplete = "off" onsubmit = "return validate();">
            ...
            <c:if test = "${null == dvd}">
                Enter DVD Details <br/><br/>${dvd.name}
            </c:if></h3>
            <table align = center width = 80% colspacing = 15>
            <tr>
                <th>Name:</th>
                <td><form:input path = "name" value = "${name}" required = "required"/></td>
            </tr>
            <tr>
                <th>Language:</th>
    ...
    <script type = "text/javascript" src = "<c:url value = '/resource/DvdStore.js' />"></script>
</html>
