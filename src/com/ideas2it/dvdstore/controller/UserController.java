...
public class UserController {
    ...
    private static final String URL_LOGIN_FORM = "login-form";
    ...
    private String login(HttpServletRequest request) {
        ...
        User user = new User();
        user.setName(request.getParameter(Constants.LABEL_NAME));
        ...
        try {
            ...
            request.getSession().setAttribute(Constants.LABEL_MESSAGE, e.getMessage());
        }
    ...
    private String logout(HttpServletRequest request) {
        ...
        return Constants.LABEL_REDIRECT + URL_LOGIN_FORM;
    }
}
